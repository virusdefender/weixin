# Django settings for weixin_mp project.
#coding=utf-8
import os
DEBUG = True
...
if ENV == "SAE":
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',  # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'weixin_mp',  # Or path to database file if using sqlite3.
            # The following settings are not used with sqlite3:
            'USER': 'root',
            'PASSWORD': 'root',
...
ROOT_URLCONF = 'weixin_mp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'weixin_mp.wsgi.application'
